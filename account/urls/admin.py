...
from ..views.admin import UserAdminAPI, GenerateUserAPI, ClassAdminAPI, ClassStudentAPI, SetClassAPI, ClassAPI, CodeAdminAPI
urlpatterns = [
    ...
    url(r"^teach_class/?$", ClassAPI.as_view(), name="class_admin_api"),
    url(r"^generate_code/?$", CodeAdminAPI.as_view(), name="code_admin_api")
]
