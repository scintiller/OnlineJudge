...
urlpatterns = [
    ...
    url(r"^api/", include("companyAnnounce1.urls.oj")),
    url(r'^api/admin/', include('companyAnnounce1.urls.admin')),
    url(r"^api/", include("companyAnnounce2.urls.oj")),
    url(r'^api/admin/', include('companyAnnounce2.urls.admin')),
]
